...
public class FrmAsistencia extends javax.swing.JFrame {
    ...
    private void cargarDatosComboBox() {
        ...
        try {
            ...
            String sql = "SELECT CONCAT(`nombre`, ' ', `apellido`) AS `nombre_completo` FROM `tbempleado` WHERE `cargo` != 'Administrador'";
            ...
            while (rs.next()) {
                ...
                cmbEmpleado.addItem(nombreCompleto);
            }
            rs.close();
            ps.close();
    ...
    private int obtenerIdEmpleado(String nombreCompleto) {
        ...
        try {
            ...
            String sql = "SELECT id_empleado FROM tbempleado WHERE CONCAT(nombre, ' ', apellido) = ?";
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cmbEmpleado, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(60, 60, 60)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
